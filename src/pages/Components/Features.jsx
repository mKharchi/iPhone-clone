        ...
        <section className="h-full common-padding bg-zinc relative overflow-hidden">
            ...
            <div className="scrim-max-width">
                ...
                >
                    ...
                    <div className="mt32 mb-24 ml-24"
                    >
                        <h2 className="text-5xl g:text-7xl font-semibold">iPhone.</h2>
                        <h2 className="text-5xl g:text-7xl font-semibold">Forged in titanium.</h2>
                    </div>
                </div>
